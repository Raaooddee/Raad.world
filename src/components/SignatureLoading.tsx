...
export function SignatureLoading() {
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="signature-reveal w-full max-w-[min(100%,28rem)] px-2 text-center sm:px-4">
        <span
          className="block text-2xl text-[var(--text)] sm:text-4xl md:text-5xl lg:text-6xl"
